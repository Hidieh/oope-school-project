...
/*
 * Scanner-luokan palveluita hyšdyntŠvŠ apuluokka int-, double-, char-
 * ja String-tyyppisten syštteiden lukemiseen. Operaatiot lukevat syštettŠ
 * jŠŠrŠpŠisesti, kunnes kŠyttŠjŠ suostuu antamaan oikean tyyppisen syštteen.
 * (Myšs pelkŠn Enter-nŠppŠimen painaminen aiheuttaa virheilmoituksen.)
 *
 * Luokkaa kŠytetŠŠn Lausekielinen ohjelmointi I ja II ja Olio-ohjelmoinnin
 * perusteet -kursseilla.
 *
 * Jorma Laurikkala (jorma.laurikkala@uta.fi), Informaatiotieteiden yksikkš
 * (tietojenkŠsittelytieteet), Tampereen yliopisto.
 *
 * Versio: 1.1.
 *
